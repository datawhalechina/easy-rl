...
![](img/2.39.png ':size=350')

所以当迭代第一次的时候，$v(s)$ 某些状态已经有些值的变化。

![](img/2.40.png ':size=350')
...
![](img/2.53.png ':size=70%')

![](img/2.54.png ':size=350')
